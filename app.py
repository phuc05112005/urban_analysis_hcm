...
key_path,
scopes=["[https://www.googleapis.com/auth/earthengine.readonly](https://www.googleapis.com/auth/earthengine.readonly)"]
)
try:
...
geom = sel.geometry.unary_union.**geo_interface**
